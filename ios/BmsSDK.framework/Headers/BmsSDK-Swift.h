...
- (void)stopBmsService;
- (void)destroySDK;
- (void)initMapWithView:(UIView * _Null_unspecified)view width:(CGFloat)width height:(CGFloat)height sdk_key:(NSString * _Nonnull)sdk_key SWIFT_METHOD_FAMILY(none);
- (void)addMarkerWithZoneName:(NSString * _Nonnull)zoneName content:(NSString * _Nonnull)content;
- (void)onDestroy;
